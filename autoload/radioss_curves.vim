...
function! radioss_curves#Read(firstLine, lastLine)
...
function! radioss_curves#Write(startLine, points, strFormat)
...
function! radioss_curves#WhatNumFormat(str, width)
...
function! radioss_curves#Shift(line1,line2,...)
  ...
  let strFormat = repeat(radioss_curves#WhatNumFormat(line1[0], 20), 2)

  " collect the data
  let points = radioss_curves#Read(a:line1,a:line2)
  ...
  " save data
  call radioss_curves#Write(a:line1, points, strFormat)

endfunction

"-------------------------------------------------------------------------------

function! radioss_curves#Scale(line1,line2,...)
...
function! radioss_curves#Resample(line1,line2,...)
  ...
  " save data
  call radioss_curves#Write(a:line1, tempPoints, strFormat)

endfunction

"-------------------------------------------------------------------------------

function! radioss_curves#AddPoint(line1,line2,...)
...
function! radioss_curves#Swap(line1,line2)
...
function! radioss_curves#Reverse(line1,line2)
  ...
  " save data
  call radioss_curves#Write(a:line1, revPoints, strFormat)
